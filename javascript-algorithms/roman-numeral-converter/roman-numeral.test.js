...
describe("Convert natural numbers to roman numeral", () => {
  ...
  test("convert 45", () => expect(convertToRoman(45)).toBe("XLV"));
  test("convert 65", () => expect(convertToRoman(65)).toBe("LXV"));
  ...
  test("convert 891", () => expect(convertToRoman(891)).toBe("DCCCXCI"));
  test("convert 1000", () => expect(convertToRoman(1000)).toBe("M"));
  test("convert 1004", () => expect(convertToRoman(1004)).toBe("MIV"));
